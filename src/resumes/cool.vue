  ...
  <div class="resume">
    ...
    <div class="content">
      <div class="content__left">
        ...
        <div v-if="person.skills" class="section">
          ...
          <div class="section-content-grid">
            <a v-for="(skill, index) in person.skills" class="grid-item" :key="index"
              :class="{ link: skill.url !== undefined }" :href="skill.url">
        ...
        <div class="section">
          ...
          <div class="section-content section-content--plain">
            ...
            <a v-if="person.contact.website" class="section-link link" :href="person.contact.website">
              <i class="section-link__icon fa fa-globe"></i>{{ person.contact.website }}
            </a>

            <a v-if="person.contact.linkedin" class="section-link link" :href="contactLinks.linkedin">
              <i class="section-link__icon fa fa-linkedin"></i>{{ person.contact.linkedin }}
            </a>

            <a v-if="person.contact.github" class="section-link link" :href="contactLinks.github">
              <i class="section-link__icon fa fa-github"></i>{{ person.contact.github }}
            </a>

            <a v-if="person.contact.twitter" class="section-link link" :href="contactLinks.twitter">
              <i class="section-link__icon fa fa-twitter"></i>{{ person.contact.twitter }}
            </a>

            <a v-if="person.contact.medium" class="section-link link" :href="contactLinks.medium">
      ...
      <div class="content__right">
        <div class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">location_city</i>{{ lang.ngo }}
          </div>

          <div class="section-content">
            <a v-for="(ngo, index) in person.ngo" :key="index" class="section-content__item"
              :class="{ link: ngo.website !== undefined }" :href="ngo.website">
              <span class="section-content__header">{{ ngo.position }}</span>
              <span class="section-content__subheader">
                {{ ngo.company }}
                <span class="section-content__plain">{{ ngo.location }}</span>
              </span>

              <div class="section-content__text__header">{{ ngo.name }}</div>
              <div class="section-content__text--light">{{ ngo.timeperiod }}</div>
          ...
          <div class="section-content">
            <a v-for="(experience, index) in person.experience" :key="index" class="section-content__item"
              :class="{ link: experience.website !== undefined }" :href="experience.website">
        ...
        <div class="section">
          ...
          <div class="section-content">
            <a v-for="(education, index) in person.education" class="section-content__item" :key="index"
              :class="{ link: education.website !== undefined }" :href="education.website">
              <span class="section-content__header">
                {{ education.school }}
              </span>
              <span class="section-content__subheader">{{
        ...
        <div v-if="person.contributions" class="section">
          ...
          <div class="section-content-grid">
            <a v-for="(contribution, index) in person.contributions" class="section-content__item-grid" :key="index"
              :class="{ link: contribution.url !== undefined }" :href="contribution.url">
              <span class="section-content__header">
                {{ contribution.name }}
              </span>
              <span class="section-content__text">
    ...
    <img class="picture" :src="person.contact.avatar" />
  </div>
</template>
