  ...
  <div class="resume">
    ...
    <div class="content">
      ...
      <div class="content__right">
        <div class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">location_city</i
            >{{ lang.ngo }}
          </div>

          <div class="section-content">
            <a
              v-for="(ngo, index) in person.ngo"
              :key="index"
              class="section-content__item"
              :class="{ link: ngo.website !== undefined }"
              :href="ngo.website"
            >
              ...
              <div class="section-content__text">{{ ngo.timeperiod }}</div>
